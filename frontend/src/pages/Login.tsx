  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0f0f0f', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <form onSubmit={handleSubmit} style={{
        ...
        <p style={{ color: '#666', textAlign: 'center', marginBottom: 24, fontSize: 13 }}>Sign in to your account</p>
        ...
        <p style={{ color: '#666', textAlign: 'center', marginTop: 16, fontSize: 13 }}>
          Don't have an account? <Link to="/register" style={{ color: '#dc2626' }}>Register</Link>
        </p>
      </form>
    </div>
  )
